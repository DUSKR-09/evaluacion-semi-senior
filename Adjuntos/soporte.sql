...
-- Table `soporte`.`users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `soporte`.`users` ;

CREATE TABLE IF NOT EXISTS `soporte`.`users` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `soporte`.`clientes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `soporte`.`clientes` ;
...
CREATE TABLE IF NOT EXISTS `soporte`.`equipo_servicios` (
  ...
  CONSTRAINT `fk_equipo_servicios_equipo_clientes1`
    ...
    REFERENCES `soporte`.`clientes` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
